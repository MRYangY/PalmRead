...
public class NewsHistoryFragment extends BaseFragment {
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (action) {
                case ProjectContent.ACTION_NEWS_HISTORY_CHANGE:
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mPageData = NewsHistoryDbUtils.cursorToPageData(NewsHistoryDbUtils.quaryDataNewHistory(getContext()), getContext());
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        filter.addAction(ProjectContent.ACTION_NEWS_HISTORY_CHANGE);
